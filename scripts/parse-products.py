...
PRODUCTS: List[Tuple[str, str]] = [
    ...
    ("korvanto-clay", "KORVANTO CLAY BALL"),
    ("korvanto-lat", "KORVANTO LAT"),
...
CATALOG_FAMILIES = [
    ...
    },
    {
        ...
        "short": "KORVANTO CLAY BALL — premium ball clay for ceramic, sanitaryware, tile, porcelain and refractory manufacturing.",
